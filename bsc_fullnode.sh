...
function start() {
  ...
  --override.fermi ${LastHardforkTime} --override.osaka ${LastHardforkTime} --override.mendel ${LastHardforkTime} --override.pasteur ${LastHardforkTime} --override.pqhardfork ${LastHardforkTime} \
